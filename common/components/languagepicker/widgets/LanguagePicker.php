...
namespace common\components\languagepicker\widgets;
 ...
 *
 * ~~~
 * \common\components\languagepicker\widgets\LanguagePicker::widget([
 *      'skin' => \common\components\languagepicker\widgets\LanguagePicker::SKIN_BUTTON,
 *      'size' => \common\components\languagepicker\widgets\LanguagePicker::SIZE_SMALL
 * ]);
 * ~~~
 *
 ...
 * ~~~
 *  \common\components\languagepicker\widgets\LanguagePicker::widget([
 *      'skin' => \common\components\languagepicker\widgets\LanguagePicker::SKIN_DROPDOWN,
 *      'size' => \common\components\languagepicker\widgets\LanguagePicker::SIZE_LARGE
 * ]);
 * ~~~
 *
 ...
 *
 *      'languageAsset' => 'common\components\languagepicker\assets\LanguageLargeIconsAsset',      // StyleSheets
 *      'languagePluginAsset' => 'common\components\languagepicker\assets\LanguagePluginAsset',    // JavasSripts
 * ]);
 * ~~~
 *
 */
class LanguagePicker extends Widget
{
    ...
    private $_SKINS = [
        self::SKIN_DROPDOWN => [
            'itemTemplate' => '<li><a href="{link}" title="{name}"><i class="{language}"></i> {name}</a></li>',
            'activeItemTemplate' => '<a href="" title="{name}"><i class="{language}"></i> {name}</a>',
            'parentTemplate' => '<div class="language-picker dropdown-list {size}"><div>{activeItem}<ul>{items}</ul></div></div>',
        ],
        self::SKIN_BUTTON => [
            'itemTemplate' => '<a href="{link}" title="{name}"><i class="{language}"></i> {name}</a>',
            'activeItemTemplate' => '<a href="{link}" title="{name}" class="active"><i class="{language}"></i> {name}</a>',
     ...
     * @var array List of pre-defined skins.
     */
    private $_SKINS_ICON_ONLY = [
        self::SKIN_DROPDOWN => [
            'itemTemplate' => '<li><a href="{link}" title="{name}"><i class="{language}"></i></a></li>',
            'activeItemTemplate' => '<a href="" title="{name}"><i class="{language}"></i></a>',
            'parentTemplate' => '<div class="language-picker dropdown-list {size}"><div>{activeItem}<ul>{items}</ul></div></div>',
        ],
        self::SKIN_BUTTON => [
            'itemTemplate' => '<a href="{link}" title="{name}"><i class="{language}"></i></a>',
            'activeItemTemplate' => '<a href="{link}" title="{name}" class="active"><i class="{language}"></i></a>',
            'parentTemplate' => '<div class="language-picker button-list {size}"><div>{items}</div></div>',
        ],
    ];
     ...
     */
    private $_SIZES = [
        self::SIZE_SMALL => 'common\components\languagepicker\assets\LanguageSmallIconsAsset',
        self::SIZE_LARGE => 'common\components\languagepicker\assets\LanguageLargeIconsAsset',
    ];
     ...
     */
    public $languagePluginAsset = 'common\components\languagepicker\assets\LanguagePluginAsset';
    ...
    private function _initSkin()
    {
        ...
        if ($this->skin && empty($this->_SKINS[$this->skin]) && empty($this->_SKINS_ICON_ONLY[$this->skin])) {
        ...
        if ($this->skin) {
            if ($this->iconOnly) {
                foreach ($this->_SKINS_ICON_ONLY[$this->skin] as $property => $value) {
                    if (!$this->$property) {
                        $this->$property = $value;
                    }
                }
