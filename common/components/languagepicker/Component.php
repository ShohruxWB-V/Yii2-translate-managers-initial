...
class Component extends \yii\base\Component
{
    ...
    /**
     * @var $callback - function to execute after changing the language of the site.
     */
    public $callback;
    ...
    public function __construct($config = array())
    {
        ...
        if (empty($config['languages'])) {
            throw new InvalidConfigException('Missing languages');
...
//        return $this->detectLanguage();
    ...
    /**
     * Redirects the browser to the referrer URL.
     * @return mixed
     */
